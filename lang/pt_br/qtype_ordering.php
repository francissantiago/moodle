...
$string['privacy:preference:gradingtype'] = 'tipodeavaliação.';
$string['privacy:preference:layouttype'] = 'tipodelayout.';
$string['privacy:preference:numberingstyle'] = 'estilodenumeração.';
$string['privacy:preference:selectcount'] = 'contagemseleção.';
$string['privacy:preference:selecttype'] = 'tipodeseleção.';
$string['privacy:preference:showgrading'] = 'mostraravaliação.';
